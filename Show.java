 ...
 * 
 * @author Miles
 * Creates the beginnings of a show
 */
public class Show extends Event {
   ...
   * Creates a Show
   */
  public Show (Venue venue, Theater theater, String startTime, String endTime,
      String name, String description, String ageRating, double price) {
